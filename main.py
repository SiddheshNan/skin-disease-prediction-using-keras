...
actions = [
    "acne keloidalis",
    "acne open/closed comodo",
    "acne pustular/excoriated/infantile",
    "actinic comedones",
...
def chooseFile():
    main_win.sourceFile = filedialog.askopenfilename(
        parent=main_win, initialdir="/mnt/WD1/python-prj/skin disease/dataset/", title='Please select a File')
...
print("Skin Disease Detected: " + actions[detected_action_index],
